...
(
 ...
 always @( posedge CLK or posedge RESET) begin
   if(RESET) begin Dinner0 <= 0; Dinner1 <= 0; Dinner2 <= 0; end
     ...
     Dinner0 <= (D00IN[23:16]<<1) + (D01IN[23:16]>>2) + (D02IN[23:16]>>2)
       + (D10IN[23:16]>>2) + (D11IN[23:16]<<1) + (D12IN[23:16]>>2)
       + (D20IN[23:16]>>2) + (D21IN[23:16]>>2) + (D22IN[23:16]<<1);

     Dinner1 <= (D00IN[15:8]<<1) + (D01IN[15:8]>>2) + (D02IN[15:8]>>2)
       + (D10IN[15:8]>>2) + (D11IN[15:8]<<1) + (D12IN[15:8]>>2)
       + (D20IN[15:8]>>2) + (D21IN[15:8]>>2) + (D22IN[15:8]<<1);

     Dinner2 <= (D00IN[7:0]<<1) + (D01IN[7:0]>>2) + (D02IN[7:0]>>2)
       + (D10IN[7:0]>>2) + (D11IN[7:0]<<1) + (D12IN[7:0]>>2)
       + (D20IN[7:0]>>2) + (D21IN[7:0]>>2) + (D22IN[7:0]<<1);
