...
module median ( CLK, RESET, D02IN, D01IN, D00IN, D12IN, D11IN, D10IN, D22IN, D21IN, D20IN, Dout);
 ...
 assign Dout[23:16] = ( Dinner2 / 9 );
 assign Dout[15:8] = ( Dinner0 / 9 );
 assign Dout[7:0] = ( Dinner1 / 9 );
// assign Dout[23:16] = ( Dinner0 >> 3);
// assign Dout[15:8] = ( Dinner1 >> 3);
// assign Dout[7:0] = ( Dinner2 >> 3);
