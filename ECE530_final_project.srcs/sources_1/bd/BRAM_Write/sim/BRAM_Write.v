...
//Date        : Fri Feb  8 17:03:04 2019
//Host        : MURAKAR-5520 running 64-bit major release  (build 9200)
//Command     : generate_target BRAM_Write.bd
//Design      : BRAM_Write
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "BRAM_Write,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=BRAM_Write,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=13,numReposBlks=13,numNonXlnxBlks=2,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,da_board_cnt=2,da_clkrst_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "BRAM_Write.hwdef" *) 
module BRAM_Write
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.M_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.M_CLOCK, CLK_DOMAIN BRAM_Write_m_clock, FREQ_HZ 125000000, PHASE 0.000" *) input m_clock;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.P_RESET RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.P_RESET, POLARITY ACTIVE_HIGH" *) input p_reset;
  input rota;
  input rota2;
  input rotb;
  input rotb2;
  ...
  wire [0:0]GND_dout;
  wire ImageProcess_0_BRAM_enable;
  wire [15:0]ImageProcess_0_bramAddr;
  wire ImageProcess_0_o_VDE;
  wire [23:0]ImageProcess_0_o_pixelData;
  wire Net;
  wire Net1;
  wire TMDS_Clk_n_1;
  wire TMDS_Clk_p_1;
  wire [2:0]TMDS_Data_n_1_1;
  wire [2:0]TMDS_Data_p_1_1;
  wire [0:0]VCC_dout;
  ...
  assign TMDS_Data_n_1_1 = TMDS_Data_n[2:0];
  assign TMDS_Data_p_1_1 = TMDS_Data_p[2:0];
  assign dispON_0_1 = dispON;
  assign hdmi_hpd[0] = VCC_dout;
  assign hdmi_out_en[0] = GND_dout;
  assign m_clock_1 = m_clock;
  assign p_reset_1 = p_reset;
  assign pattern_0_1 = SWs[2:0];
  assign rota2_0_1 = rota2;
  assign rota_0_1 = rota;
  assign rotb2_0_1 = rotb2;
  assign rotb_0_1 = rotb;
  ...
  BRAM_Write_GND_0 GND
       (.dout(GND_dout));
  BRAM_Write_ImageProcess_0_0 ImageProcess_0
       (.BRAM_enable(ImageProcess_0_BRAM_enable),
        .Clock(dvi2rgb_0_PixelClk),
        .HSync(dvi2rgb_0_vid_pHSync),
        .Reset(p_reset_1),
        .VSync(dvi2rgb_0_vid_pVSync),
        .bramAddr(ImageProcess_0_bramAddr),
        .color_data(axi_bram_ctrl_0_bram_douta[24:0]),
        .dispON(dispON_0_1),
        .i_VDE(dvi2rgb_0_vid_pVDE),
        .i_pixelData(dvi2rgb_0_vid_pData),
        .o_VDE(ImageProcess_0_o_VDE),
        .o_pixelData(ImageProcess_0_o_pixelData),
        .pattern(pattern_0_1),
        .rota(rota_0_1),
        .rota2(rota2_0_1),
        .rotb(rotb_0_1),
        .rotb2(rotb2_0_1));
  BRAM_Write_VCC_0 VCC
       (.dout(VCC_dout));
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > BRAM_Write axi_bram_ctrl_0_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  BRAM_Write_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  BRAM_Write_axi_bram_ctrl_0_bram_0 axi_bram_ctrl_0_bram
       (.addra(ImageProcess_0_bramAddr),
  ...
  BRAM_Write_clk_wiz_0 clk_wiz
       (.clk_in1(m_clock_1),
        .clk_out1(clk_wiz_clk_out1),
        .locked(clk_wiz_locked),
        .reset(p_reset_1));
  BRAM_Write_dvi2rgb_0_0 dvi2rgb_0
       (.PixelClk(dvi2rgb_0_PixelClk),
        ...
        .TMDS_Data_n(TMDS_Data_n_1_1),
        .TMDS_Data_p(TMDS_Data_p_1_1),
        .aRst_n(clk_wiz_locked),
        .pRst_n(clk_wiz_locked),
        .vid_pData(dvi2rgb_0_vid_pData),
        .vid_pHSync(dvi2rgb_0_vid_pHSync),
        .vid_pVDE(dvi2rgb_0_vid_pVDE),
        .vid_pVSync(dvi2rgb_0_vid_pVSync));
  BRAM_Write_iobuf_0_0 iobuf_0
       (.I(dvi2rgb_0_SDA_O),
        .IO(sda_io),
        .O(iobuf_0_O),
        .T(dvi2rgb_0_SDA_T));
  BRAM_Write_iobuf_1_0 iobuf_1
       (.I(dvi2rgb_0_SCL_O),
        .IO(scl_io),
        .O(iobuf_1_O),
        .T(dvi2rgb_0_SCL_T));
  BRAM_Write_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  (* BMM_INFO_PROCESSOR = "arm > BRAM_Write axi_bram_ctrl_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  BRAM_Write_processing_system7_0_0 processing_system7_0
  ...
  BRAM_Write_rgb2vga_0_0 rgb2vga_0
       (.PixelClk(dvi2rgb_0_PixelClk),
        .rgb_pData(ImageProcess_0_o_pixelData),
        .rgb_pHSync(dvi2rgb_0_vid_pHSync),
        .rgb_pVDE(ImageProcess_0_o_VDE),
