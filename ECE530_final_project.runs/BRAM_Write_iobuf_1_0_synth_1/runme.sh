...
HD_PWD='C:/Users/murakar/xup/embedded/2015_2_zynq_labs/PS_PL_coop/PS_PL_coop.runs/BRAM_Write_iobuf_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_Write_iobuf_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM_Write_iobuf_1_0.tcl
