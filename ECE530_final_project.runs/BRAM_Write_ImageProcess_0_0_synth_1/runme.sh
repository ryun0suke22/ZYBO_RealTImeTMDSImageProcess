...
HD_PWD='C:/Users/murakar/xup/embedded/2015_2_zynq_labs/ECE530_final_project/ECE530_final_project.runs/BRAM_Write_ImageProcess_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_Write_ImageProcess_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM_Write_ImageProcess_0_0.tcl
