...
HD_PWD='C:/Users/murakar/xup/embedded/2015_2_zynq_labs/ECE530_final_project/ECE530_final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_Write_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BRAM_Write_wrapper.tcl -notrace
