...
#
# Generated by export_simulation on Fri Feb 08 15:04:46 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './BRAM_Write.sh' script.

./BRAM_Write.sh -reset_run
...
./BRAM_Write.sh -noclean_files

For more information on the script, please type './BRAM_Write.sh -help'.
